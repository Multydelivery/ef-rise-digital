...
export default function Work() {
  ...
  const projects = useMemo(() => {
    return t.work.projects.map((proj, index) => ({
      ...
      link: index === 0 ? "https://bella-italia-restaurant-two.vercel.app/" : index === 1 ? "https://real-state-lead-demo.vercel.app/" : index === 2 ? "https://local-gym-app.vercel.app/es" : index === 3 ? "https://melo-store-iccy.vercel.app/" : "#",
      tags: [
