export default function Contact() {
  return (
    <section id="contact" className="mx-auto max-w-6xl px-4 py-20">
      <div className="rounded-3xl border-2 border-gray-200 bg-white/90 backdrop-blur-sm p-10 md:p-12 shadow-2xl">
        <h2 className="text-4xl font-black md:text-5xl bg-gradient-to-r from-gray-800 via-gray-900 to-amber-600 bg-clip-text text-transparent">Get a free visibility audit</h2>
        ...
        <form className="mt-10 grid gap-5 md:grid-cols-2">
          ...
          <button
            type="button"
            className="rounded-2xl bg-gradient-to-r from-gray-800 via-gray-900 to-amber-600 px-8 py-4 text-base font-bold text-white shadow-2xl shadow-gray-900/50 hover:shadow-amber-600/50 transition-all duration-300 hover:scale-105 md:col-span-2"
          >
            Request Audit
          </button>
